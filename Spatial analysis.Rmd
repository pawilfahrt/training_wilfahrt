...
pop_joined <- st_join(ak_regions_3338, pop_4326, join = st_within)
## we can see above that the coordinate reference systems (last four digits) are not going to join
...
## Incorporate static maps from ggmap
